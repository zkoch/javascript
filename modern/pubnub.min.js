// 3.4.2
(function(){
function l(){return function(){}}var m=1,n=!1,s=[],t="-pnpres",y=1E3,aa=/{([\w\-]+)}/g;function ba(){return"x"+ ++m+""+ +new Date}function D(){return+new Date}var E,G=Math.floor(20*Math.random());E=function(a,b){return 0<a.indexOf("pubsub.")&&a.replace("pubsub","ps"+(b?J().split("-")[0]:20>++G?G:G=1))||a};function ca(a,b){function d(){e+b>D()?(clearTimeout(c),c=setTimeout(d,b)):(e=D(),a())}var c,e=0;return d}function da(a,b){var d=[];K(a||[],function(a){b(a)&&d.push(a)});return d}
...
d=JSON.stringify(d);e=[v,"publish",p,g,0,M(e),f,M(d)];j.push({a:f,timeout:5*y,url:e,data:{uuid:x},c:function(a){b(a);c(1)},b:function(){b([0,"Failed",d]);c(1)}});c()},unsubscribe:function(a){a=a.channel;C=0;O=1;a=L((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+t}).join(",");K(a.split(","),function(a){n&&f.LEAVE(a,0);i[a]=0});n&&b()},subscribe:function(a,c){function e(a){a?setTimeout(j,y):(v=E(z,1),V=E(z,1),setTimeout(function(){f.time(e)},y));d(function(b){if(a&&b.d)return b.d=0,
b.j(b.name);!a&&!b.d&&(b.d=1,b.i(b.name))})}function j(){var a=r(),b=P(i).join(",");b&&(N=q({timeout:B,a:a,b:function(){f.time(e)},data:{uuid:x},url:[V,"subscribe",g,M(b),a,C],c:function(a){if(!a)return setTimeout(j,Z);d(function(a){a.e||(a.e=1,a.h(a.name))});(C=!C&&O&&w.get(g)||a[1])&&w.set(g,a[1]);var b,c=(2<a.length?a[2]:"").split(",");b=function(){var a=c.shift()||"";return[(i[a]||{}).a||W,(a||X).split(t)[0]]};K(a[0],function(c){var d=b();if(i[d[1]].f)d[0](c,a,d[1])});setTimeout(j,Z)}}))}var H=
a.channel,c=(c=c||a.callback)||a.message,p=a.connect||l(),I=a.reconnect||l(),u=a.disconnect||l(),h=a.presence||0,k=a.noheresync||0,B=a.timeout||A,Z=a.windowing||F;a.restore&&(O=1);C=0;if(!H)return error("Missing Channel");if(!c)return error("Missing Callback");if(!g)return error("Missing Subscribe Key");K((H.join?H.join(","):""+H).split(","),function(a){var b=i[a]||{};i[X=a]={name:a,e:b.e,d:b.d,f:1,a:W=c,h:p,i:u,j:I};h&&(f.subscribe({channel:a+t,callback:h}),!b.f&&!k&&f.here_now({channel:a,callback:function(b){K("uuids"in
b?b.uuids:[],function(c){h({action:"join",uuid:c,timestamp:D(),occupancy:b.occupancy||1},b,a)})}}))});b=function(){f._reset_offline();clearTimeout(Y);Y=setTimeout(j,100)};if(!n)return s.push(b);b()},here_now:function(a,b){var b=a.callback||b,c=a.error||l(),d=a.channel,e=r(),f=null;if(!d)return error("Missing Channel");if(!b)return error("Missing Callback");if(!g)return error("Missing Subscribe Key");"0"!=e&&(f={},f.callback=e);q({a:e,data:f,c:function(a){b(a)},b:c,url:[v,"v2","presence","sub_key",
g,"channel",M(d)]})},xdr:q,ready:fa,db:w,uuid:J,each:K,map:L,grep:da,supplant:ea,now:D,unique:ba,updater:ca,poll_online:function(){ia()||f._reset_offline();setTimeout(f.poll_online,y)},poll_online2:function(){f.time(function(a){a||f._reset_offline();setTimeout(f.poll_online2,u)})}};x||(x=f.uuid());w.set(g+"uuid",x);setTimeout(f.poll_online,y);setTimeout(f.poll_online2,u);e=f;e.init=T;if(a.notest)return e;S("beforeunload",window,function(){each_channel(function(a){e.LEAVE(a.name,1)});return!0});S("offline",
