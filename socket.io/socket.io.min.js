...
typeof c.length))throw Error("JSON.stringify");return b("",{"":a})});"function"!==typeof JSON.parse&&(JSON.parse=function(a){return eval("("+a+")")})}();var aa=1,v=r,ba=[],w="-pnpres",z=1E3,da="/",ea="&",ha=/{([\w\-]+)}/g;function D(){return"x"+ ++aa+""+ +new Date}function E(){return+new Date}var H,ia=Math.floor(20*Math.random());H=function(a,c){return 0<a.indexOf("pubsub.")&&a.replace("pubsub","ps"+(c?ja().split("-")[0]:20>++ia?ia:ia=1))||a};
function ka(a,c){var b=a.join(da),d=[];if(!c)return b;M(c,function(a,b){d.push(a+"="+N(b))});return b+="?"+d.join(ea)}function la(a,c){function b(){e+c>E()?(clearTimeout(d),d=setTimeout(b,c)):(e=E(),a())}var d,e=0;return b}function ma(a,c){var b=[];M(a||[],function(a){c(a)&&b.push(a)});return b}function na(a,c){return a.replace(ha,function(a,d){return c[d]||a})}
...
a,e):c["on"+a]=e})},sa=function(){return ra("head")[0]},S=function(a,c,b){if(b)a.setAttribute(c,b);else return a&&a.getAttribute&&a.getAttribute(c)},ta=function(a,c){for(var b in c)if(c.hasOwnProperty(b))try{a.style[b]=c[b]+(0<"|width|height|top|left|".indexOf(b)&&"number"==typeof c[b]?"px":"")}catch(d){}},va=function(a){return document.createElement(a)},wa=function(){return T||U()?0:D()},za=function(a){function c(a,b){O||(O=1,f.onerror=n,clearTimeout(u),a||!b||X(b),setTimeout(function(){a&&Y();var b=
Q(x),c=b&&b.parentNode;c&&c.removeChild(b)},z))}if(T||U()){a:{var b,d,e=function(){if(!q){q=1;clearTimeout(g);try{d=JSON.parse(b.responseText)}catch(a){return j(1)}s=1;xa=!0;i(d)}},s=0,q=0,k=a.timeout||1E4,g=setTimeout(function(){j(1)},k),G=a.b||t(),h=a.data||{},i=a.c||t(),l="undefined"===typeof a.g,j=function(a){s||(s=1,clearTimeout(g),b&&(b.onerror=b.onload=n,b.abort&&b.abort(),b=n),a&&G())};try{b=U()||window.XDomainRequest&&new XDomainRequest||new XMLHttpRequest;b.onerror=b.onabort=function(){j(1)};
b.onload=b.onloadend=e;l&&(b.timeout=k);h.pnsdk=ya;var m=ka(a.url,h);b.open("GET",m,l);b.send()}catch(L){j(0);xa||(T=0);a=za(a);break a}a=j}return a}var f=va("script"),e=a.a,x=D(),O=0,u=setTimeout(function(){c(1)},a.timeout||1E4),Y=a.b||t(),k=a.data||{},X=a.c||t();window[e]=function(a){c(0,a)};a.g||(f[Aa]=Aa);f.onerror=function(){c(1)};k.pnsdk=ya;f.src=ka(a.url,k);S(f,"id",x);sa().appendChild(f);return c},Ba=function(){return!("onLine"in navigator)?1:navigator.onLine},U=function(){if(!Ca||!Ca.get)return 0;
var a={id:U.id++,send:t(),abort:function(){a.id={}},open:function(c,b){U[a.id]=a;Ca.get(a.id,b)}};return a},Aa="async",ya="PubNub-JS-Web/3.5.0",xa=r,T=-1==navigator.userAgent.indexOf("MSIE 6");window.console||(window.console=window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||t());var Da,V=window.localStorage;Da={get:function(a){try{return V?V.getItem(a):-1==document.cookie.indexOf(a)?n:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||n}catch(c){}},
set:function(a,c){try{if(V)return V.setItem(a,c)&&0;document.cookie=a+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(b){}}};var W={list:{},unbind:function(a){W.list[a]=[]},bind:function(a,c){(W.list[a]=W.list[a]||[]).push(c)},fire:function(a,c){M(W.list[a]||[],function(a){a(c)})}},Z=Q("pubnub")||0,Ea=function(a){function c(){}function b(){I&&I(1);I=n}function d(){y.time(function(a){a||b();setTimeout(d,i)})}function e(){fa()||b();setTimeout(e,z)}function s(a){var b=0;M(oa(A),function(c){if(c=
A[c])b++,(a||t())(c)});return b}function q(a){a&&(u.h=0);!u.h&&u.length&&(u.h=1,B(u.shift()))}a.jsonp&&(T=0);var k=a.subscribe_key||"";a.uuid||Da.get(k+"uuid");a.xdr=za;a.db=Da;a.error=qa;a._is_online=Ba;a.jsonp_cb=wa;var g,G=+a.windowing||10,h=(+a.timeout||310)*z,i=(+a.keepalive||3600)*z,l=a.publish_key||"",j=a.subscribe_key||"",m=a.auth_key||"",L=a.ssl?"s":"",f="http"+L+"://"+(a.origin||"pubsub.pubnub.com"),x=H(f),O=H(f),u=[],Y=0,X=0,I=0,ca=0,J=0,A={},B=a.xdr,p=a.error||t(),fa=a._is_online||function(){return 1},
F=a.jsonp_cb||function(){return 0},K=a.db||{get:t(),set:t()},C=a.uuid||K&&K.get(j+"uuid")||"",y={LEAVE:function(a,b){var c={uuid:C,auth:m},d=H(f),e=F();0<a.indexOf(w)||("0"!=e&&(c.callback=e),B({g:b||L,timeout:2E3,a:e,data:c,url:[d,"v2","presence","sub_key",j,"channel",N(a),"leave"]}))},history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||t(),f=a.channel,g=a.start,i=a.end,h={},l=F();if(!f)return p("Missing Channel");if(!b)return p("Missing Callback");if(!j)return p("Missing Subscribe Key");
...
z));s(function(b){if(a&&b.d)return b.d=0,b.m(b.name);!a&&!b.d&&(b.d=1,b.l(b.name))})}function i(){var a=F(),d=oa(A).join(",");d&&(b(),I=B({timeout:Ga,a:a,b:function(){I=n;y.time(e)},data:{uuid:C,auth:m},url:[O,"subscribe",j,N(d),a,J],c:function(a){I=n;if(!a)return setTimeout(c,ga);J=!J&&ca&&K.get(j)||a[1];s(function(a){a.f||(a.f=1,a.k(a.name))});ua&&(J=1E4,ua=0);K.set(j,a[1]);var b,d=(2<a.length?a[2]:P(A,function(b){return P(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");
b=function(){var a=d.shift()||X;return[(A[a]||{}).a||Y,a.split(w)[0]]};M(a[0],function(c){var d=b();d[0](c,a,d[1])});setTimeout(i,ga)}}))}var g=a.channel,d=(d=d||a.callback)||a.message,k=a.connect||t(),l=a.reconnect||t(),q=a.disconnect||t(),u=a.presence||0,L=a.noheresync||0,ua=a.backfill||0,fa=a.timetoken||0,Ga=a.timeout||h,ga=a.windowing||G;ca=a.restore;J=fa;if(!g)return p("Missing Channel");if(!d)return p("Missing Callback");if(!j)return p("Missing Subscribe Key");M((g.join?g.join(","):""+g).split(","),
function(a){var b=A[a]||{};A[X=a]={name:a,f:b.f,d:b.d,j:1,a:Y=d,k:k,l:q,m:l};u&&(y.subscribe({channel:a+w,callback:u}),!b.j&&!L&&y.here_now({channel:a,callback:function(b){M("uuids"in b?b.uuids:[],function(c){u({action:"join",uuid:c,timestamp:E(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){b();setTimeout(i,ga)};if(!v)return ba.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||t(),d=a.channel,e=F(),f={uuid:C,auth:m};if(!d)return p("Missing Channel");if(!b)return p("Missing Callback");
if(!j)return p("Missing Subscribe Key");"0"!=e&&(f.callback=e);B({a:e,data:f,c:function(a){b(a)},b:c,url:[x,"v2","presence","sub_key",j,"channel",N(d)]})},xdr:B,ready:pa,db:K,uuid:ja,map:P,each:M,"each-channel":s,grep:ma,offline:b,supplant:na,now:E,unique:D,updater:la};C||(C=y.uuid());K.set(j+"uuid",C);setTimeout(e,z);setTimeout(d,i);y.time(t());g=y;g.css=ta;g.$=Q;g.create=va;g.bind=R;g.head=sa;g.search=ra;g.attr=S;g.events=W;g.init=Ea;R("beforeunload",window,function(){g["each-channel"](function(a){g.LEAVE(a.name,
1)});return!0});if(a.notest)return g;R("offline",window,g.offline);R("offline",document,g.offline);return g};R("load",window,function(){setTimeout(pa,0)});var $=Z||{};PUBNUB=Ea({notest:1,publish_key:S($,"pub-key"),subscribe_key:S($,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==S($,"ssl"),origin:S($,"origin"),uuid:S($,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=PUBNUB);"undefined"!==typeof module&&(module.exports=PUBNUB)&&pa();var Ca=Q("pubnubs")||0;if(Z){ta(Z,{position:"absolute",
...
Fa.prototype.send=function(a){var c=this;c.e.publish({channel:c.e.i.channel,message:a,callback:function(a){c.onsend({data:a})}})};
})();
(function(){
