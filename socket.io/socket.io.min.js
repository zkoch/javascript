// 3.4.3
(function(){
function aa(b){throw b;}var q=!0,t=null,u=!1;function v(){return function(){}}function y(b){return function(){return b}}
...
typeof c.length))&&aa(Error("JSON.stringify"));return a("",{"":b})});"function"!==typeof JSON.parse&&(JSON.parse=function(a){return eval("("+a+")")})}();var ba=1,A=u,E=[],H="-pnpres",ca=10,I=1E4,da=310,ea=60,J=1E3,fa=/{([\w\-]+)}/g;function L(){return"x"+ ++ba+""+ +new Date}function M(){return+new Date}var O,ga=Math.floor(20*Math.random());O=function(b,c){return 0<b.indexOf("pubsub.")&&b.replace("pubsub","ps"+(c?P().split("-")[0]:20>++ga?ga:ga=1))||b};
...
function l(){var a=C(),b=Z(x).join(",");b&&(f=z({timeout:W,a:a,c:function(){s.time(r)},data:{uuid:G},url:[i,"subscribe",p,Y(b),a,B],d:function(a){if(!a)return V(l,N);d(function(a){a.g||(a.g=1,a.k(a.name))});(B=!B&&D&&F.get(p)||a[1])&&F.set(p,a[1]);var b,c=(2<a.length?a[2]:"").split(",");b=function(){var a=c.shift()||"";return[(x[a]||{}).a||j,(a||n).split(H)[0]]};T(a[0],function(c){var d=b();if(x[d[1]].h)d[0](c,a,d[1])});V(l,N)}}))}var m=a.channel,b=(b=b||a.callback)||a.message,Qa=a.connect||v(),w=
a.reconnect||v(),ja=a.disconnect||v(),Q=a.presence||0,ha=a.noheresync||0,W=a.timeout||k,N=a.windowing||e;a.restore&&(D=1);B=0;if(!m)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");T((m.join?m.join(","):""+m).split(","),function(a){var c=x[a]||{};x[n=a]={name:a,g:c.g,e:c.e,h:1,a:j=b,k:Qa,l:ja,m:w};Q&&(s.subscribe({channel:a+H,callback:Q}),!c.h&&!ha&&s.here_now({channel:a,callback:function(b){T("uuids"in b?b.uuids:[],function(c){Q({action:"join",
uuid:c,timestamp:M(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){s._reset_offline();clearTimeout(K);K=V(l,100)};if(!A)return E.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||v(),d=a.channel,e=C(),h=t;if(!d)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");"0"!=e&&(h={},h.callback=e);z({a:e,data:h,d:function(a){b(a)},c:c,url:[g,"v2","presence","sub_key",p,"channel",Y(d)]})},xdr:z,ready:$,db:F,uuid:P,each:T,
...
function(){return na("head")[0]},qa=function(b,c,a){if(a)b.setAttribute(c,a);else return b&&b.getAttribute&&b.getAttribute(c)},ra=function(b,c){for(var a in c)if(c.hasOwnProperty(a))try{b.style[a]=c[a]+(0<"|width|height|top|left|".indexOf(a)&&"number"==typeof c[a]?"px":"")}catch(d){}},sa=function(b){return document.createElement(b)},va=function(){return ta||ua()?0:L()},ya=function(b){function c(a,b){D||(D=1,a||x(b),n.onerror=t,clearTimeout(K),V(function(){a&&B();var b=ma(f),c=b&&b.parentNode;c&&c.removeChild(b)},
J))}if(ta||ua()){a:{var a,d,e=function(){if(!w){w=1;clearTimeout(p);try{d=JSON.parse(a.responseText)}catch(b){return g(1)}h(d)}},k=0,w=0,l=b.timeout||I,p=V(function(){g(1)},l),r=b.c||v(),h=b.d||v(),g=function(b){k||(k=1,clearTimeout(p),a&&(a.onerror=a.onload=t,a.abort&&a.abort(),a=t),b&&r())};try{a=ua()||window.XDomainRequest&&new XDomainRequest||new XMLHttpRequest;a.onerror=a.onabort=function(){g(1)};a.onload=a.onloadend=e;a.timeout=l;var i=b.url.join(wa);if(b.data){var e=[],m;console.log(b.data);
i+="?";for(m in b.data)e.push(m+"="+b.data[m]);i+=e.join(xa)}a.open("GET",i,typeof("undefined"===b.i));a.send()}catch(j){g(0);ta=0;b=ya(b);break a}b=g}return b}var n=sa("script"),i=b.a,f=L(),D=0,K=V(function(){c(1)},b.timeout||I),B=b.c||v(),x=b.d||v();window[i]=function(a){c(0,a)};b.i||(n[za]=za);n.onerror=function(){c(1)};n.src=b.url.join(wa);if(b.data){i=[];n.src+="?";for(e in b.data)i.push(e+"="+b.data[e]);n.src+=i.join(xa)}qa(n,"id",f);pa().appendChild(n);return c},Aa=function(){return!("onLine"in
navigator)?1:navigator.onLine},ua=function(){if(!Ba||!Ba.get)return 0;var b={id:ua.id++,send:v(),abort:function(){b.id={}},open:function(c,a){ua[b.id]=b;Ba.get(b.id,a)}};return b},za="async",wa="/",xa="&",ta=-1==navigator.userAgent.indexOf("MSIE 6");window.console||(window.console=window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||v());var Ca,Da=window.localStorage;Ca={get:function(b){try{return Da?Da.getItem(b):-1==document.cookie.indexOf(b)?t:((document.cookie||
"").match(RegExp(b+"=([^;]+)"))||[])[1]||t}catch(c){}},set:function(b,c){try{if(Da)return Da.setItem(b,c)&&0;document.cookie=b+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(a){}}};var Ea={list:{},unbind:function(b){Ea.list[b]=[]},bind:function(b,c){(Ea.list[b]=Ea.list[b]||[]).push(c)},fire:function(b,c){T(Ea.list[b]||[],function(a){a(c)})}},Fa=ma("pubnub")||0,Ga=function(b){b.jsonp&&(ta=0);var c=b.subscribe_key||"";b.uuid||Ca.get(c+"uuid");b.xdr=ya;b.db=Ca;b._is_online=Aa;b.jsonp_cb=
va;var a=la(b);a.css=ra;a.$=ma;a.create=sa;a.bind=oa;a.head=pa;a.search=na;a.attr=qa;a.events=Ea;a.init=Ga;if(b.notest)return a;oa("beforeunload",window,function(){each_channel(function(b){a.LEAVE(b.name,1)});return q});oa("offline",window,a._reset_offline);oa("offline",document,a._reset_offline);return a};oa("load",window,function(){V($,0)});var Ha=Fa||{};PUBNUB=Ga({notest:1,publish_key:qa(Ha,"pub-key"),subscribe_key:qa(Ha,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==qa(Ha,"ssl"),
origin:qa(Ha,"origin"),uuid:qa(Ha,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=PUBNUB);"undefined"!==typeof module&&(module.exports=PUBNUB)&&$();var Ba=ma("pubnubs")||0;if(Fa){ra(Fa,{position:"absolute",top:-J});if("opera"in window||qa(Fa,"flash"))Fa.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";PUBNUB.rdx=function(b,c){if(!c)return ua[b].onerror();
ua[b].responseText=unescape(c);ua[b].onload()};ua.id=J}}
...
Ia.prototype.send=function(b){var c=this;c.b.publish({channel:c.b.f.channel,message:b,callback:function(a){c.onsend({data:a})}})};
...
case "object":if(!f)return"null";e+=k;j=[];if("[object Array]"===Object.prototype.toString.apply(f)){m=f.length;for(h=0;h<m;h+=1)j[h]=a(h,f)||"null";i=0===j.length?"[]":e?"[\n"+e+j.join(",\n"+e)+"\n"+n+"]":"["+j.join(",")+"]";e=n;return i}if(l&&"object"===typeof l){m=l.length;for(h=0;h<m;h+=1)g=l[h],"string"===typeof g&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i)}else for(g in f)Object.hasOwnProperty.call(f,g)&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i);i=0===j.length?"{}":e?"{\n"+e+j.join(",\n"+e)+"\n"+
n+"}":"{"+j.join(",")+"}";e=n;return i}}window.JSON||(window.JSON={});var d=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,k,w={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},l;"function"!==typeof JSON.stringify&&(JSON.stringify=function(b,c,d){var g;k=e="";if("number"===typeof d)for(g=0;g<d;g+=1)k+=" ";else"string"===typeof d&&(k=d);(l=c)&&("function"!==typeof c&&("object"!==typeof c||"number"!==
typeof c.length))&&aa(Error("JSON.stringify"));return a("",{"":b})});"function"!==typeof JSON.parse&&(JSON.parse=function(a){return eval("("+a+")")})}();ba=1;A=u;E=[];H="-pnpres";ca=10;I=1E4;da=310;ea=60;J=1E3;fa=/{([\w\-]+)}/g;function L(){return"x"+ ++ba+""+ +new Date}function M(){return+new Date}var Ka=Math.floor(20*Math.random());O=function(b,c){return 0<b.indexOf("pubsub.")&&b.replace("pubsub","ps"+(c?P().split("-")[0]:20>++Ka?Ka:Ka=1))||b};
function R(b,c){function a(){e+c>M()?(clearTimeout(d),d=setTimeout(a,c)):(e=M(),b())}var d,e=0;return a}function S(b,c){var a=[];T(b||[],function(b){c(b)&&a.push(b)});return a}function U(b,c){return b.replace(fa,function(a,b){return c[b]||a})}function V(b,c){return setTimeout(b,c)}function P(b){var c="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"==a?b:b&3|8).toString(16)});b&&b(c);return c}
function T(b,c){if(b&&c)if("undefined"!=typeof b[0])for(var a=0,d=b.length;a<d;)c.call(b[a],b[a],a++);else for(a in b)b.hasOwnProperty&&b.hasOwnProperty(a)&&c.call(b[a],a,b[a])}function X(b,c){var a=[];T(b||[],function(b,e){a.push(c(b,e))});return a}function Y(b){return X(encodeURIComponent(b).split(""),function(b){return 0>"-_.!~*'()".indexOf(b)?b:"%"+b.charCodeAt(0).toString(16).toUpperCase()}).join("")}function Z(b){var c=[];T(b,function(a,b){b.h&&c.push(a)});return c.sort()}
function $(){V(function(){A||(A=1,T(E,function(b){b()}))},J)}
function la(b){function c(){}function a(a){a&&(m.j=0);!m.j&&m.length&&(m.j=1,z(m.shift()))}function d(a){T(Z(x),function(b){(b=x[b])&&a(b)})}var e=+b.windowing||ca,k=(+b.timeout||da)*J,w=(+b.keepalive||ea)*J,l=b.publish_key||"",p=b.subscribe_key||"",r=b.ssl?"s":"",h="http"+r+"://"+(b.origin||"pubsub.pubnub.com"),g=O(h),i=O(h),m=[],j=0,n=0,f=0,D=0,K=0,B=0,x={},z=b.xdr,N=b._is_online||y(1),C=b.jsonp_cb||y(0),F=b.db||{get:v(),set:v()},G=b.uuid||F&&F.get(p+"uuid")||"",s={_reset_offline:function(){f&&
...
function l(){var a=C(),b=Z(x).join(",");b&&(f=z({timeout:W,a:a,c:function(){s.time(r)},data:{uuid:G},url:[i,"subscribe",p,Y(b),a,B],d:function(a){if(!a)return V(l,N);d(function(a){a.g||(a.g=1,a.k(a.name))});(B=!B&&D&&F.get(p)||a[1])&&F.set(p,a[1]);var b,c=(2<a.length?a[2]:"").split(",");b=function(){var a=c.shift()||"";return[(x[a]||{}).a||j,(a||n).split(H)[0]]};T(a[0],function(c){var d=b();if(x[d[1]].h)d[0](c,a,d[1])});V(l,N)}}))}var m=a.channel,b=(b=b||a.callback)||a.message,Qa=a.connect||v(),w=
a.reconnect||v(),ja=a.disconnect||v(),Q=a.presence||0,ha=a.noheresync||0,W=a.timeout||k,N=a.windowing||e;a.restore&&(D=1);B=0;if(!m)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");T((m.join?m.join(","):""+m).split(","),function(a){var c=x[a]||{};x[n=a]={name:a,g:c.g,e:c.e,h:1,a:j=b,k:Qa,l:ja,m:w};Q&&(s.subscribe({channel:a+H,callback:Q}),!c.h&&!ha&&s.here_now({channel:a,callback:function(b){T("uuids"in b?b.uuids:[],function(c){Q({action:"join",
uuid:c,timestamp:M(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){s._reset_offline();clearTimeout(K);K=V(l,100)};if(!A)return E.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||v(),d=a.channel,e=C(),f=t;if(!d)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");"0"!=e&&(f={},f.callback=e);z({a:e,data:f,d:function(a){b(a)},c:c,url:[g,"v2","presence","sub_key",p,"channel",Y(d)]})},xdr:z,ready:$,db:F,uuid:P,each:T,
map:X,grep:S,supplant:U,now:M,unique:L,updater:R,poll_online:function(){N()||s._reset_offline();V(s.poll_online,J)},poll_online2:function(){s.time(function(a){a||s._reset_offline();V(s.poll_online2,w)})}};G||(G=s.uuid());F.set(p+"uuid",G);V(s.poll_online,J);V(s.poll_online2,w);return s}
window.JSON&&window.JSON.stringify||function(){function b(){try{return this.valueOf()}catch(a){return t}}function c(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=w[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function a(d,r){var h,g,i,m,j,n=e,f=r[d];f&&"object"===typeof f&&(f=b.call(f));"function"===typeof l&&(f=l.call(r,d,f));switch(typeof f){case "string":return c(f);case "number":return isFinite(f)?String(f):"null";case "boolean":case "null":return String(f);
case "object":if(!f)return"null";e+=k;j=[];if("[object Array]"===Object.prototype.toString.apply(f)){m=f.length;for(h=0;h<m;h+=1)j[h]=a(h,f)||"null";i=0===j.length?"[]":e?"[\n"+e+j.join(",\n"+e)+"\n"+n+"]":"["+j.join(",")+"]";e=n;return i}if(l&&"object"===typeof l){m=l.length;for(h=0;h<m;h+=1)g=l[h],"string"===typeof g&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i)}else for(g in f)Object.hasOwnProperty.call(f,g)&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i);i=0===j.length?"{}":e?"{\n"+e+j.join(",\n"+e)+"\n"+
n+"}":"{"+j.join(",")+"}";e=n;return i}}window.JSON||(window.JSON={});var d=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,k,w={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},l;"function"!==typeof JSON.stringify&&(JSON.stringify=function(b,c,d){var g;k=e="";if("number"===typeof d)for(g=0;g<d;g+=1)k+=" ";else"string"===typeof d&&(k=d);(l=c)&&("function"!==typeof c&&("object"!==typeof c||"number"!==
typeof c.length))&&aa(Error("JSON.stringify"));return a("",{"":b})});"function"!==typeof JSON.parse&&(JSON.parse=function(a){return eval("("+a+")")})}();
if(!window.PUBNUB){var La=function(b){return document.getElementById(b)},Ma=function(b,c){var a=[];T(b.split(/\s+/),function(b){T((c||document).getElementsByTagName(b),function(b){a.push(b)})});return a},Na=function(b,c,a){T(b.split(","),function(b){function e(b){b||(b=window.event);a(b)||(b.cancelBubble=q,b.returnValue=u,b.preventDefault&&b.preventDefault(),b.stopPropagation&&b.stopPropagation())}c.addEventListener?c.addEventListener(b,e,u):c.attachEvent?c.attachEvent("on"+b,e):c["on"+b]=e})},Oa=
function(){return Ma("head")[0]},Pa=function(b,c,a){if(a)b.setAttribute(c,a);else return b&&b.getAttribute&&b.getAttribute(c)},Sa=function(b,c){for(var a in c)if(c.hasOwnProperty(a))try{b.style[a]=c[a]+(0<"|width|height|top|left|".indexOf(a)&&"number"==typeof c[a]?"px":"")}catch(d){}},Ta=function(b){return document.createElement(b)},Wa=function(){return Ua||Va()?0:L()},Za=function(b){function c(a,b){D||(D=1,a||x(b),n.onerror=t,clearTimeout(K),V(function(){a&&B();var b=La(f),c=b&&b.parentNode;c&&c.removeChild(b)},
...
i+="?";for(m in b.data)e.push(m+"="+b.data[m]);i+=e.join(Ya)}a.open("GET",i,typeof("undefined"===b.i));a.send()}catch(j){g(0);Ua=0;b=Za(b);break a}b=g}return b}var n=Ta("script"),i=b.a,f=L(),D=0,K=V(function(){c(1)},b.timeout||I),B=b.c||v(),x=b.d||v();window[i]=function(a){c(0,a)};b.i||(n[$a]=$a);n.onerror=function(){c(1)};n.src=b.url.join(Xa);if(b.data){i=[];n.src+="?";for(e in b.data)i.push(e+"="+b.data[e]);n.src+=i.join(Ya)}Pa(n,"id",f);Oa().appendChild(n);return c},ab=function(){return!("onLine"in
...
"").match(RegExp(b+"=([^;]+)"))||[])[1]||t}catch(c){}},set:function(b,c){try{if(db)return db.setItem(b,c)&&0;document.cookie=b+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(a){}}};var eb={list:{},unbind:function(b){eb.list[b]=[]},bind:function(b,c){(eb.list[b]=eb.list[b]||[]).push(c)},fire:function(b,c){T(eb.list[b]||[],function(a){a(c)})}},fb=La("pubnub")||0,gb=function(b){b.jsonp&&(Ua=0);var c=b.subscribe_key||"";b.uuid||cb.get(c+"uuid");b.xdr=Za;b.db=cb;b._is_online=ab;b.jsonp_cb=
Wa;var a=la(b);a.css=Sa;a.$=La;a.create=Ta;a.bind=Na;a.head=Oa;a.search=Ma;a.attr=Pa;a.events=eb;a.init=gb;if(b.notest)return a;Na("beforeunload",window,function(){each_channel(function(b){a.LEAVE(b.name,1)});return q});Na("offline",window,a._reset_offline);Na("offline",document,a._reset_offline);return a};Na("load",window,function(){V($,0)});var hb=fb||{};PUBNUB=gb({notest:1,publish_key:Pa(hb,"pub-key"),subscribe_key:Pa(hb,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==Pa(hb,"ssl"),
origin:Pa(hb,"origin"),uuid:Pa(hb,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=PUBNUB);"undefined"!==typeof module&&(module.exports=PUBNUB)&&$();var bb=La("pubnubs")||0;if(fb){Sa(fb,{position:"absolute",top:-J});if("opera"in window||Pa(fb,"flash"))fb.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";PUBNUB.rdx=function(b,c){if(!c)return Va[b].onerror();
...
tb;var a=la(b);a.css=pb;a.$=kb;a.create=qb;a.bind=mb;a.head=nb;a.search=lb;a.attr=ob;a.events=Cb;a.init=Eb;if(b.notest)return a;mb("beforeunload",window,function(){each_channel(function(b){a.LEAVE(b.name,1)});return q});mb("offline",window,a._reset_offline);mb("offline",document,a._reset_offline);return a};mb("load",window,function(){V($,0)});var Fb=Db||{};PUBNUB=Eb({notest:1,publish_key:ob(Fb,"pub-key"),subscribe_key:ob(Fb,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==ob(Fb,"ssl"),
...
Sb;var a=la(b);a.css=Ob;a.$=Jb;a.create=Pb;a.bind=Lb;a.head=Mb;a.search=Kb;a.attr=Nb;a.events=ac;a.init=cc;if(b.notest)return a;Lb("beforeunload",window,function(){each_channel(function(b){a.LEAVE(b.name,1)});return q});Lb("offline",window,a._reset_offline);Lb("offline",document,a._reset_offline);return a};Lb("load",window,function(){V($,0)});var dc=bc||{};PUBNUB=cc({notest:1,publish_key:Nb(dc,"pub-key"),subscribe_key:Nb(dc,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==Nb(dc,"ssl"),
...
qc;var a=la(b);a.css=mc;a.$=hc;a.create=nc;a.bind=jc;a.head=kc;a.search=ic;a.attr=lc;a.events=zc;a.init=Bc;if(b.notest)return a;jc("beforeunload",window,function(){each_channel(function(b){a.LEAVE(b.name,1)});return q});jc("offline",window,a._reset_offline);jc("offline",document,a._reset_offline);return a};jc("load",window,function(){V($,0)});var Cc=Ac||{};PUBNUB=Bc({notest:1,publish_key:lc(Cc,"pub-key"),subscribe_key:lc(Cc,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==lc(Cc,"ssl"),
...
a.reconnect||v(),ja=a.disconnect||v(),Q=a.presence||0,ha=a.noheresync||0,W=a.timeout||k,N=a.windowing||e;a.restore&&(D=1);B=0;if(!m)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");T((m.join?m.join(","):""+m).split(","),function(a){var c=x[a]||{};x[n=a]={name:a,g:c.g,e:c.e,h:1,a:j=b,k:w,l:ja,m:Ra};Q&&(s.subscribe({channel:a+H,callback:Q}),!c.h&&!ha&&s.here_now({channel:a,callback:function(b){T("uuids"in b?b.uuids:[],function(c){Q({action:"join",
uuid:c,timestamp:M(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){s._reset_offline();clearTimeout(K);K=V(r,100)};if(!A)return E.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||v(),d=a.channel,e=C(),f=t;if(!d)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");"0"!=e&&(f={},f.callback=e);z({a:e,data:f,d:function(a){b(a)},c:c,url:[g,"v2","presence","sub_key",p,"channel",Y(d)]})},xdr:z,ready:$,db:F,uuid:P,each:T,
map:X,grep:S,supplant:U,now:M,unique:L,updater:R,poll_online:function(){N()||s._reset_offline();V(s.poll_online,J)},poll_online2:function(){s.time(function(a){a||s._reset_offline();V(s.poll_online2,w)})}};G||(G=s.uuid());F.set(p+"uuid",G);V(s.poll_online,J);V(s.poll_online2,w);return s}
window.JSON&&window.JSON.stringify||function(){function b(){try{return this.valueOf()}catch(a){return t}}function c(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=w[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function a(d,r){var h,g,i,m,j,n=e,f=r[d];f&&"object"===typeof f&&(f=b.call(f));"function"===typeof l&&(f=l.call(r,d,f));switch(typeof f){case "string":return c(f);case "number":return isFinite(f)?String(f):"null";case "boolean":case "null":return String(f);
case "object":if(!f)return"null";e+=k;j=[];if("[object Array]"===Object.prototype.toString.apply(f)){m=f.length;for(h=0;h<m;h+=1)j[h]=a(h,f)||"null";i=0===j.length?"[]":e?"[\n"+e+j.join(",\n"+e)+"\n"+n+"]":"["+j.join(",")+"]";e=n;return i}if(l&&"object"===typeof l){m=l.length;for(h=0;h<m;h+=1)g=l[h],"string"===typeof g&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i)}else for(g in f)Object.hasOwnProperty.call(f,g)&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i);i=0===j.length?"{}":e?"{\n"+e+j.join(",\n"+e)+"\n"+
...
Pc;var a=la(b);a.css=Lc;a.$=Gc;a.create=Mc;a.bind=Ic;a.head=Jc;a.search=Hc;a.attr=Kc;a.events=Yc;a.init=$c;if(b.notest)return a;Ic("beforeunload",window,function(){each_channel(function(b){a.LEAVE(b.name,1)});return q});Ic("offline",window,a._reset_offline);Ic("offline",document,a._reset_offline);return a};Ic("load",window,function(){V($,0)});var ad=Zc||{};PUBNUB=$c({notest:1,publish_key:Kc(ad,"pub-key"),subscribe_key:Kc(ad,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==Kc(ad,"ssl"),
...
Y(d)]})},xdr:z,ready:$,db:F,uuid:P,each:T,map:X,grep:S,supplant:U,now:M,unique:L,updater:R,poll_online:function(){N()||s._reset_offline();V(s.poll_online,J)},poll_online2:function(){s.time(function(a){a||s._reset_offline();V(s.poll_online2,w)})}};G||(G=s.uuid());F.set(p+"uuid",G);V(s.poll_online,J);V(s.poll_online2,w);return s}
window.JSON&&window.JSON.stringify||function(){function b(){try{return this.valueOf()}catch(a){return t}}function c(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=w[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function a(d,r){var h,g,i,m,j,n=e,f=r[d];f&&"object"===typeof f&&(f=b.call(f));"function"===typeof l&&(f=l.call(r,d,f));switch(typeof f){case "string":return c(f);case "number":return isFinite(f)?String(f):"null";case "boolean":case "null":return String(f);
case "object":if(!f)return"null";e+=k;j=[];if("[object Array]"===Object.prototype.toString.apply(f)){m=f.length;for(h=0;h<m;h+=1)j[h]=a(h,f)||"null";i=0===j.length?"[]":e?"[\n"+e+j.join(",\n"+e)+"\n"+n+"]":"["+j.join(",")+"]";e=n;return i}if(l&&"object"===typeof l){m=l.length;for(h=0;h<m;h+=1)g=l[h],"string"===typeof g&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i)}else for(g in f)Object.hasOwnProperty.call(f,g)&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i);i=0===j.length?"{}":e?"{\n"+e+j.join(",\n"+e)+"\n"+
n+"}":"{"+j.join(",")+"}";e=n;return i}}window.JSON||(window.JSON={});var d=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,k,w={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},l;"function"!==typeof JSON.stringify&&(JSON.stringify=function(b,c,d){var g;k=e="";if("number"===typeof d)for(g=0;g<d;g+=1)k+=" ";else"string"===typeof d&&(k=d);(l=c)&&("function"!==typeof c&&("object"!==typeof c||"number"!==
typeof c.length))&&aa(Error("JSON.stringify"));return a("",{"":b})});"function"!==typeof JSON.parse&&(JSON.parse=function(a){return eval("("+a+")")})}();
...
nd;var a=la(b);a.css=jd;a.$=ed;a.create=kd;a.bind=gd;a.head=hd;a.search=fd;a.attr=id;a.events=wd;a.init=yd;if(b.notest)return a;gd("beforeunload",window,function(){each_channel(function(b){a.LEAVE(b.name,1)});return q});gd("offline",window,a._reset_offline);gd("offline",document,a._reset_offline);return a};gd("load",window,function(){V($,0)});var zd=xd||{};PUBNUB=yd({notest:1,publish_key:id(zd,"pub-key"),subscribe_key:id(zd,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==id(zd,"ssl"),
...
f);h&&(k.end=h);a&&(k.count=a);z({a:j,d:function(a){b(a)},c:function(){b([0,"Disconnected"])},url:[g,"v1","replay",l,p,c,d],data:k})},time:function(a){var b=C();z({a:b,timeout:5*J,url:[g,"time",b],d:function(b){a(b[0])},c:function(){a(0)}})},publish:function(b,c){var c=c||b.callback||v(),d=b.message,e=b.channel,f=C();if(!d)return error("Missing Message");if(!e)return error("Missing Channel");if(!l)return error("Missing Publish Key");if(!p)return error("Missing Subscribe Key");d=JSON.stringify(d);
e=[g,"publish",l,p,0,Y(e),f,Y(d)];m.push({a:f,timeout:5*J,url:e,data:{uuid:G},d:function(b){c(b);a(1)},c:function(){c([0,"Failed",d]);a(1)}});a()},unsubscribe:function(a){a=a.channel;B=0;D=1;a=X((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+H}).join(",");T(a.split(","),function(a){A&&s.LEAVE(a,0);x[a]=0});A&&c()},subscribe:function(a,b){function l(a){a?V(m,J):(g=O(h,1),i=O(h,1),V(function(){s.time(l)},J));d(function(b){if(a&&b.e)return b.e=0,b.m(b.name);!a&&!b.e&&(b.e=1,b.l(b.name))})}
function m(){var a=C(),b=Z(x).join(",");b&&(f=z({timeout:ka,a:a,c:function(){s.time(l)},data:{uuid:G},url:[i,"subscribe",p,Y(b),a,B],d:function(a){if(!a)return V(m,ia);d(function(a){a.g||(a.g=1,a.k(a.name))});B=!B&&D&&F.get(p)||a[1];W&&(Timetoken=1E4,W=0);F.set(p,a[1]);var b,c=(2<a.length?a[2]:"").split(",");b=function(){var a=c.shift()||"";return[(x[a]||{}).a||j,(a||n).split(H)[0]]};T(a[0],function(c){var d=b();if(x[d[1]].h)d[0](c,a,d[1])});V(m,ia)}}))}var r=a.channel,b=(b=b||a.callback)||a.message,
w=a.connect||v(),Ra=a.reconnect||v(),N=a.disconnect||v(),Q=a.presence||0,ha=a.noheresync||0,W=a.backfill||0,ka=a.timeout||k,ia=a.windowing||e;a.restore&&(D=1);B=0;if(!r)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");T((r.join?r.join(","):""+r).split(","),function(a){var c=x[a]||{};x[n=a]={name:a,g:c.g,e:c.e,h:1,a:j=b,k:w,l:N,m:Ra};Q&&(s.subscribe({channel:a+H,callback:Q}),!c.h&&!ha&&s.here_now({channel:a,callback:function(b){T("uuids"in
b?b.uuids:[],function(c){Q({action:"join",uuid:c,timestamp:M(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){s._reset_offline();clearTimeout(K);K=V(m,100)};if(!A)return E.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||v(),d=a.channel,e=C(),f=t;if(!d)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");"0"!=e&&(f={},f.callback=e);z({a:e,data:f,d:function(a){b(a)},c:c,url:[g,"v2","presence","sub_key",p,"channel",
Y(d)]})},xdr:z,ready:$,db:F,uuid:P,each:T,map:X,grep:S,supplant:U,now:M,unique:L,updater:R,poll_online:function(){N()||s._reset_offline();V(s.poll_online,J)},poll_online2:function(){s.time(function(a){a||s._reset_offline();V(s.poll_online2,w)})}};G||(G=s.uuid());F.set(p+"uuid",G);V(s.poll_online,J);V(s.poll_online2,w);return s}
window.JSON&&window.JSON.stringify||function(){function b(){try{return this.valueOf()}catch(a){return t}}function c(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=w[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function a(d,r){var h,g,i,m,j,n=e,f=r[d];f&&"object"===typeof f&&(f=b.call(f));"function"===typeof l&&(f=l.call(r,d,f));switch(typeof f){case "string":return c(f);case "number":return isFinite(f)?String(f):"null";case "boolean":case "null":return String(f);
case "object":if(!f)return"null";e+=k;j=[];if("[object Array]"===Object.prototype.toString.apply(f)){m=f.length;for(h=0;h<m;h+=1)j[h]=a(h,f)||"null";i=0===j.length?"[]":e?"[\n"+e+j.join(",\n"+e)+"\n"+n+"]":"["+j.join(",")+"]";e=n;return i}if(l&&"object"===typeof l){m=l.length;for(h=0;h<m;h+=1)g=l[h],"string"===typeof g&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i)}else for(g in f)Object.hasOwnProperty.call(f,g)&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i);i=0===j.length?"{}":e?"{\n"+e+j.join(",\n"+e)+"\n"+
...
ke;var a=la(b);a.css=ge;a.$=be;a.create=he;a.bind=de;a.head=ee;a.search=ce;a.attr=fe;a.events=te;a.init=ve;if(b.notest)return a;de("beforeunload",window,function(){each_channel(function(b){a.LEAVE(b.name,1)});return q});de("offline",window,a._reset_offline);de("offline",document,a._reset_offline);return a};de("load",window,function(){V($,0)});var we=ue||{};PUBNUB=ve({notest:1,publish_key:fe(we,"pub-key"),subscribe_key:fe(we,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==fe(we,"ssl"),
...
e=[g,"publish",l,p,0,Y(e),f,Y(d)];m.push({a:f,timeout:5*J,url:e,data:{uuid:G},d:function(b){c(b);a(1)},c:function(){c([0,"Failed",d]);a(1)}});a()},unsubscribe:function(a){a=a.channel;B=0;D=1;a=X((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+H}).join(",");T(a.split(","),function(a){A&&s.LEAVE(a,0);x[a]=0});A&&c()},subscribe:function(a,b){function l(a){a?V(m,J):(g=O(h,1),i=O(h,1),V(function(){s.time(l)},J));d(function(b){if(a&&b.e)return b.e=0,b.m(b.name);!a&&!b.e&&(b.e=1,b.l(b.name))})}
function m(){var a=C(),b=Z(x).join(",");b&&(f=z({timeout:ka,a:a,c:function(){s.time(l)},data:{uuid:G},url:[i,"subscribe",p,Y(b),a,B],d:function(a){if(!a)return V(m,ia);d(function(a){a.g||(a.g=1,a.k(a.name))});B=!B&&D&&F.get(p)||a[1];W&&(Timetoken=1E4,W=0);F.set(p,a[1]);var b,c=(2<a.length?a[2]:"").split(",");b=function(){var a=c.shift()||"";return[(x[a]||{}).a||j,(a||n).split(H)[0]]};T(a[0],function(c){var d=b();if(x[d[1]].h)d[0](c,a,d[1])});V(m,ia)}}))}var r=a.channel,b=(b=b||a.callback)||a.message,
w=a.connect||v(),N=a.reconnect||v(),ja=a.disconnect||v(),Q=a.presence||0,ha=a.noheresync||0,W=a.backfill||0,ka=a.timeout||k,ia=a.windowing||e;a.restore&&(D=1);B=0;if(!r)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");T((r.join?r.join(","):""+r).split(","),function(a){var c=x[a]||{};x[n=a]={name:a,g:c.g,e:c.e,h:1,a:j=b,k:w,l:ja,m:N};Q&&(s.subscribe({channel:a+H,callback:Q}),!c.h&&!ha&&s.here_now({channel:a,callback:function(b){T("uuids"in
b?b.uuids:[],function(c){Q({action:"join",uuid:c,timestamp:M(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){s._reset_offline();clearTimeout(K);K=V(m,100)};if(!A)return E.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||v(),d=a.channel,e=C(),f=t;if(!d)return error("Missing Channel");if(!b)return error("Missing Callback");if(!p)return error("Missing Subscribe Key");"0"!=e&&(f={},f.callback=e);z({a:e,data:f,d:function(a){b(a)},c:c,url:[g,"v2","presence","sub_key",p,"channel",
Y(d)]})},xdr:z,ready:$,db:F,uuid:P,each:T,map:X,grep:S,supplant:U,now:M,unique:L,updater:R,poll_online:function(){N()||s._reset_offline();V(s.poll_online,J)},poll_online2:function(){s.time(function(a){a||s._reset_offline();V(s.poll_online2,w)})}};G||(G=s.uuid());F.set(p+"uuid",G);V(s.poll_online,J);V(s.poll_online2,w);return s}
window.JSON&&window.JSON.stringify||function(){function b(){try{return this.valueOf()}catch(a){return t}}function c(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=w[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function a(d,r){var h,g,i,m,j,n=e,f=r[d];f&&"object"===typeof f&&(f=b.call(f));"function"===typeof l&&(f=l.call(r,d,f));switch(typeof f){case "string":return c(f);case "number":return isFinite(f)?String(f):"null";case "boolean":case "null":return String(f);
case "object":if(!f)return"null";e+=k;j=[];if("[object Array]"===Object.prototype.toString.apply(f)){m=f.length;for(h=0;h<m;h+=1)j[h]=a(h,f)||"null";i=0===j.length?"[]":e?"[\n"+e+j.join(",\n"+e)+"\n"+n+"]":"["+j.join(",")+"]";e=n;return i}if(l&&"object"===typeof l){m=l.length;for(h=0;h<m;h+=1)g=l[h],"string"===typeof g&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i)}else for(g in f)Object.hasOwnProperty.call(f,g)&&(i=a(g,f))&&j.push(c(g)+(e?": ":":")+i);i=0===j.length?"{}":e?"{\n"+e+j.join(",\n"+e)+"\n"+
...
hf;var a=la(b);a.css=df;a.$=Ze;a.create=ef;a.bind=af;a.head=bf;a.search=$e;a.attr=cf;a.events=rf;a.init=tf;if(b.notest)return a;af("beforeunload",window,function(){each_channel(function(b){a.LEAVE(b.name,1)});return q});af("offline",window,a._reset_offline);af("offline",document,a._reset_offline);return a};af("load",window,function(){V($,0)});var uf=sf||{};PUBNUB=tf({notest:1,publish_key:cf(uf,"pub-key"),subscribe_key:cf(uf,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==cf(uf,"ssl"),
...
c)&&0;document.cookie=b+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(a){}}};var Qf=yf("pubnub")||{},Rf=function(b){var c=b.subscribe_key||"";b.uuid||Of.get(c+"uuid");c={xdr:Lf,db:Of,each:T,map:X,grep:S,css:Df,$:yf,create:Ef,bind:Af,supplant:U,head:Bf,search:zf,attr:Cf,now:M,unique:L,events:events,updater:R,init:Rf};b.xdr=Lf;b.db=Of;b.jsonp_cb=Hf;b.bind_leave=function(){Af("beforeunload",window,function(){each_channel(v());return q})};c.__proto__=la(b);return c};PUBNUB=Rf({publish_key:Cf(Qf,
...
c)&&0;document.cookie=b+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(a){}}};var Hg=pg("pubnub")||{},Ig=function(b){var c=b.subscribe_key||"";b.uuid||Fg.get(c+"uuid");c={xdr:Cg,db:Fg,each:T,map:X,grep:S,css:ug,$:pg,create:vg,bind:rg,supplant:U,head:sg,search:qg,attr:tg,now:M,unique:L,events:events,updater:R,init:Ig};b.xdr=Cg;b.db=Fg;b.jsonp_cb=yg;b.bind_leave=function(){rg("beforeunload",window,function(){each_channel(v());return q})};c.__proto__=la(b);return c};PUBNUB=Ig({publish_key:tg(Hg,
