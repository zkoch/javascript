...
a,e):c["on"+a]=e})},sa=function(){return ra("head")[0]},S=function(a,c,b){if(b)a.setAttribute(c,b);else return a&&a.getAttribute&&a.getAttribute(c)},va=function(a,c){for(var b in c)if(c.hasOwnProperty(b))try{a.style[b]=c[b]+(0<"|width|height|top|left|".indexOf(b)&&"number"==typeof c[b]?"px":"")}catch(d){}},wa=function(a){return document.createElement(a)},xa=function(){return T||U()?0:E()},za=function(a){function c(a,b){O||(O=1,f.onerror=n,clearTimeout(u),a||!b||X(b),setTimeout(function(){a&&Y();var b=
...
b.onload=b.onloadend=e;l&&(b.timeout=k);h.pnsdk=ya;var m=ka(a.url,h);b.open("GET",m,l);b.send()}catch(D){j(0);T=0;a=za(a);break a}a=j}return a}var f=wa("script"),e=a.a,x=E(),O=0,u=setTimeout(function(){c(1)},a.timeout||1E4),Y=a.b||t(),k=a.data||{},X=a.c||t();window[e]=function(a){c(0,a)};a.g||(f[Aa]=Aa);f.onerror=function(){c(1)};k.pnsdk=ya;f.src=ka(a.url,k);S(f,"id",x);sa().appendChild(f);return c},Ba=function(){return!("onLine"in navigator)?1:navigator.onLine},U=function(){if(!Ca||!Ca.get)return 0;
var a={id:U.id++,send:t(),abort:function(){a.id={}},open:function(c,b){U[a.id]=a;Ca.get(a.id,b)}};return a},Aa="async",ya="PubNub-JS-Web/3.5.1",T=-1==navigator.userAgent.indexOf("MSIE 6");window.console||(window.console=window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||t());var Da,V=window.localStorage;Da={get:function(a){try{return V?V.getItem(a):-1==document.cookie.indexOf(a)?n:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||n}catch(c){}},set:function(a,
c){try{if(V)return V.setItem(a,c)&&0;document.cookie=a+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(b){}}};var W={list:{},unbind:function(a){W.list[a]=[]},bind:function(a,c){(W.list[a]=W.list[a]||[]).push(c)},fire:function(a,c){M(W.list[a]||[],function(a){a(c)})}},Z=Q("pubnub")||0,Ea=function(a){function c(){}function b(a){J&&J(a);J=n}function d(){y.time(function(a){a||b(1);setTimeout(d,i)})}function e(){fa()||b(1);setTimeout(e,z)}function s(a){var b=0;M(oa(A),function(c){if(c=A[c])b++,
(a||t())(c)});return b}function q(a){a&&(u.h=0);!u.h&&u.length&&(u.h=1,B(u.shift()))}a.jsonp&&(T=0);var k=a.subscribe_key||"";a.uuid||Da.get(k+"uuid");a.xdr=za;a.db=Da;a.error=qa;a._is_online=Ba;a.jsonp_cb=xa;var g,H=+a.windowing||10,h=(+a.timeout||310)*z,i=(+a.keepalive||60)*z,l=a.publish_key||"",j=a.subscribe_key||"",m=a.auth_key||"",D=a.ssl?"s":"",f="http"+D+"://"+(a.origin||"pubsub.pubnub.com"),x=I(f),O=I(f),u=[],Y=0,X=0,J=0,ca=0,K=0,A={},B=a.xdr,p=a.error||t(),fa=a._is_online||function(){return 1},
...
z));s(function(b){if(a&&b.d)return b.d=0,b.m(b.name);!a&&!b.d&&(b.d=1,b.l(b.name))})}function i(){var a=F(),d=oa(A).join(",");d&&(b(),J=B({timeout:Ga,a:a,b:function(){J=n;y.time(e)},data:{uuid:C,auth:m},url:[O,"subscribe",j,N(d),a,K],c:function(a){J=n;if(!a||"error"in a&&!a.error)return u(a),setTimeout(c,ga);K=!K&&ca&&L.get(j)||a[1];s(function(a){a.f||(a.f=1,a.k(a.name))});ta&&(K=1E4,ta=0);L.set(j,a[1]);var b,d=(2<a.length?a[2]:P(A,function(b){return P(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");
b=function(){var a=d.shift()||X;return[(A[a]||{}).a||Y,a.split(w)[0]]};M(a[0],function(c){var d=b();d[0](c,a,d[1])});setTimeout(i,ga)}}))}var g=a.channel,d=(d=d||a.callback)||a.message,k=a.connect||t(),l=a.reconnect||t(),q=a.disconnect||t(),u=a.error||t(),D=a.presence||0,fa=a.noheresync||0,ta=a.backfill||0,Ha=a.timetoken||0,Ga=a.timeout||h,ga=a.windowing||H,ua=a.restore;ca=ua;K=Ha;if(!g)return p("Missing Channel");if(!d)return p("Missing Callback");if(!j)return p("Missing Subscribe Key");M((g.join?
g.join(","):""+g).split(","),function(a){var b=A[a]||{};A[X=a]={name:a,f:b.f,d:b.d,j:1,a:Y=d,k:k,l:q,m:l};D&&(y.subscribe({channel:a+w,restore:ua,callback:D}),!b.j&&!fa&&y.here_now({channel:a,callback:function(b){M("uuids"in b?b.uuids:[],function(c){D({action:"join",uuid:c,timestamp:G(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){b();setTimeout(i,ga)};if(!v)return ba.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||t(),d=a.channel,e=F(),f={uuid:C,auth:m};if(!d)return p("Missing Channel");
if(!b)return p("Missing Callback");if(!j)return p("Missing Subscribe Key");"0"!=e&&(f.callback=e);B({a:e,data:f,c:function(a){b(a)},b:c,url:[x,"v2","presence","sub_key",j,"channel",N(d)]})},xdr:B,ready:pa,db:L,uuid:ja,map:P,each:M,"each-channel":s,grep:ma,offline:function(){b(1)},supplant:na,now:G,unique:E,updater:la};C||(C=y.uuid());L.set(j+"uuid",C);setTimeout(e,z);setTimeout(d,i);y.time(t());g=y;g.css=va;g.$=Q;g.create=wa;g.bind=R;g.head=sa;g.search=ra;g.attr=S;g.events=W;g.init=Ea;R("beforeunload",
