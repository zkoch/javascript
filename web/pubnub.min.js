...
auth:e},c:function(a){"object"==typeof a&&a.error?g(a):b(a);f(1)},b:function(a){g(a);f(1)}});f()},unsubscribe:function(a){a=a.channel;S=0;na=1;a=Q((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+z}).join(",");P(a.split(","),function(a){v&&w.LEAVE(a,0);I[a]=0});c()},subscribe:function(a,b){function e(a){a?setTimeout(c,D):(H=G(M,1),wa=G(M,1),setTimeout(function(){w.time(e)},D));E(function(b){if(a&&b.e)return b.e=0,b.m(b.name);!a&&!b.e&&(b.e=1,b.l(b.name))})}function g(){var a=C(),b=
qa(I).join(",");b&&(d(),R=x({timeout:O,a:a,b:function(a){n(a);R=m;w.time(e)},data:{uuid:J,auth:i},url:[wa,"subscribe",j,U(b),a,S],c:function(a){R=m;if(!a||"object"==typeof a&&"error"in a&&a.error)return n(a),setTimeout(c,D);r(a[1]);S=!S&&na&&T.get(j)||a[1];E(function(a){a.f||(a.f=1,a.k(a.name))});B&&(S=1E4,B=0);T.set(j,a[1]);var b,d=(2<a.length?a[2]:Q(I,function(b){return Q(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=d.shift()||Aa;return[(I[a]||
{}).a||za,a.split(z)[0]]};var e=F()-ja-+a[1]/1E4;P(a[0],function(c){var d=b();d[0](c,a,d[1],e)});setTimeout(g,L)}}))}var f=a.channel,b=(b=b||a.callback)||a.message,i=a.auth_key||h,y=a.connect||u(),N=a.reconnect||u(),q=a.disconnect||u(),n=a.error||u(),r=a.idle||u(),s=a.presence||0,A=a.noheresync||0,B=a.backfill||0,K=a.timetoken||0,O=a.timeout||l,L=a.windowing||p;na=a.restore;S=K;if(!f)return k("Missing Channel");if(!b)return k("Missing Callback");if(!j)return k("Missing Subscribe Key");P((f.join?f.join(","):
...
u();b.binaryType="";b.extensions="";b.bufferedAmount=0;b.trasnmitting=t;b.buffer=[];b.readyState=b.CONNECTING;if(!a)return b.readyState=b.CLOSED,b.onclose({code:b.CLOSE_ABNORMAL,reason:"Missing URL",wasClean:!0}),b;b.d=PUBNUB.init(d);b.d.g=d;b.g=d;b.d.subscribe({restore:t,channel:d.channel,disconnect:b.onerror,reconnect:b.onopen,error:function(){b.onclose({code:b.CLOSE_ABNORMAL,reason:"Missing URL",wasClean:t})},callback:function(a){b.onmessage({data:a})},connect:function(){b.readyState=b.OPEN;b.onopen()}})};
Ma.prototype.send=function(a){var c=this;c.d.publish({channel:c.d.g.channel,message:a,callback:function(a){c.onsend({data:a})}})};Ma.prototype.close=function(){this.d.unsubscribe({channel:this.d.g.channel});this.readyState=this.CLOSED;this.onclose({})};
})();
